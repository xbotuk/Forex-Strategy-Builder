// Momentum MA Oscillator Indicator
...
namespace ForexStrategyBuilder
{
    ...
    /// Momentum MA Oscillator Indicator
    /// </summary>
    public class Momentum_MA_Oscillator : Indicator
    {
        /// <summary>
        /// Sets the default indicator parameters for the designated slot type
        /// </summary>
        public Momentum_MA_Oscillator(SlotTypes slotType)
        {
            // General properties
            ...
            IndParam.ListParam[3].ToolTip  = "The price the Momentum is based on.";

            // The NumericUpDown parameters
            IndParam.NumParam[0].Caption = "Momentum period";
