...
namespace ForexStrategyBuilder
{
    ...
    /// ATR MA Oscillator Indicator
    /// </summary>
    public class ATR_MA_Oscillator : Indicator
    {
        /// <summary>
...
// ---------------------------------------------------------
            ...
            ATR.Calculate(slotType);

            adIndicator1 = ATR.Component[0].Value;
 ...
 // ----------------------------------------------------------
            ...
            {
                case "The ATR MA Oscillator rises":
                    indLogic = IndicatorLogic.The_indicator_rises;
                    break;

                case "The ATR MA Oscillator falls":
                    indLogic = IndicatorLogic.The_indicator_falls;
                    break;

                case "The ATR MA Oscillator is higher than the zero line":
                    indLogic = IndicatorLogic.The_indicator_is_higher_than_the_level_line;
                    break;

                case "The ATR MA Oscillator is lower than the zero line":
                    indLogic = IndicatorLogic.The_indicator_is_lower_than_the_level_line;
                    break;

                case "The ATR MA Oscillator crosses the zero line upward":
                    indLogic = IndicatorLogic.The_indicator_crosses_the_level_line_upward;
                    break;

                case "The ATR MA Oscillator crosses the zero line downward":
                    indLogic = IndicatorLogic.The_indicator_crosses_the_level_line_downward;
                    break;

                case "The ATR MA Oscillator changes its direction upward":
                    indLogic = IndicatorLogic.The_indicator_changes_its_direction_upward;
                    break;

                case "The ATR MA Oscillator changes its direction downward":
