...
namespace ForexStrategyBuilder
{
    ...
    /// RSI MA Oscillator Indicator
    /// </summary>
    public class RSI_MA_Oscillator : Indicator
    {
        /// <summary>
        ...
        public RSI_MA_Oscillator(SlotTypes slotType)
        {
            ...
            {
                "The RSI MA Oscillator rises",
                "The RSI MA Oscillator falls",
                "The RSI MA Oscillator is higher than the zero line",
                "The RSI MA Oscillator is lower than the zero line",
                "The RSI MA Oscillator crosses the zero line upward",
                "The RSI MA Oscillator crosses the zero line downward",
                "The RSI MA Oscillator changes its direction upward",
                "The RSI MA Oscillator changes its direction downward"
            };
