...
namespace ForexStrategyBuilder
{
    ...
    public class Envelopes : Indicator
    {
        ...
        /// </summary>
        public Envelopes(SlotTypes slotType)
        {
            // General properties
            ...
            IndParam.NumParam[1].Caption = "Deviation %";
            IndParam.NumParam[1].Value   = 1;
            IndParam.NumParam[1].Min     = 0.01;
            IndParam.NumParam[1].Max     = 20;
            IndParam.NumParam[1].Point   = 2;
            IndParam.NumParam[1].Enabled = true;
            IndParam.NumParam[1].ToolTip = "Deviation from the central MA in per cents.";
        ...
        public override string ToString()
        {
            string sString = IndicatorName +
                ...
                IndParam.NumParam[1].ValueToString + ")";   // Deviation %
