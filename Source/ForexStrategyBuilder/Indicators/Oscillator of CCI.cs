...
namespace ForexStrategyBuilder
{
    ...
    public class Oscillator_of_CCI : Indicator
    {
        ...
        public Oscillator_of_CCI(SlotTypes slotType)
        {
            ...
            IndParam.ListParam[2].ToolTip  = "The price the CCI is based on.";

            // The NumericUpDown parameters
            IndParam.NumParam[0].Caption = "First CCI period";
            IndParam.NumParam[0].Value   = 14;
            IndParam.NumParam[0].Min     = 1;
            IndParam.NumParam[0].Max     = 200;
            IndParam.NumParam[0].Enabled = true;
            IndParam.NumParam[0].ToolTip = "The period of first CCI.";

            IndParam.NumParam[1].Caption = "Second CCI period";
            IndParam.NumParam[1].Value   = 20;
            IndParam.NumParam[1].Min     = 1;
            IndParam.NumParam[1].Max     = 200;
            IndParam.NumParam[1].Enabled = true;
            IndParam.NumParam[1].ToolTip = "The period of second CCI.";
...
// ---------------------------------------------------------
            ...
            adIndicator1 = CCI1.Component[0].Value;
            adIndicator2 = CCI2.Component[0].Value;
// ----------------------------------------------------------
