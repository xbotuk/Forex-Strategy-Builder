    ...
    public partial class Strategy
    {
        ...
        public string GenerateBBCode()
        {
            ...
            strBBCode += "Swap Long in " +
                (Data.InstrProperties.SwapType == CommissionType.money ? Data.InstrProperties.PriceIn : Data.InstrProperties.SwapType.ToString()) + ": " +
            ...
            strBBCode += "Commission per " +
                ...
                (Data.InstrProperties.CommissionTime == CommissionTime.open ? "opening" : "opening and closing") + " in " +
                (Data.InstrProperties.CommissionType == CommissionType.money ? Data.InstrProperties.PriceIn : Data.InstrProperties.CommissionType.ToString()) + ": " +
        ...
        StringBuilder EnvironmentHTMLReport()
        {
            ...
            string swapUnit   = (Data.InstrProperties.SwapType == CommissionType.money ? Data.InstrProperties.PriceIn : Language.T(Data.InstrProperties.SwapType.ToString()));
            ...
            string commUnit   = (Data.InstrProperties.CommissionType == CommissionType.money ? Data.InstrProperties.PriceIn : Language.T(Data.InstrProperties.CommissionType.ToString()));
        ...
        StringBuilder StrategySlotsHTMLReport()
        {
            ...
            string brkEven = Data.Strategy.UseBreakEven ? Data.Strategy.BreakEven.ToString(CultureInfo.InvariantCulture) : Language.T("None");
